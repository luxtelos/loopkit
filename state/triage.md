...
| Criterion 4 of specs/findings-are-concepts.md: patch the vendored actor or wait upstream (2026-09-09) | inbox/needs-human.md § Criterion 4 of specs/findings-are-concepts.md: patch the vendored actor | medium |  | blocked |
