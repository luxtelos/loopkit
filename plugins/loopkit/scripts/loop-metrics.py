#!/usr/bin/env python3
"""loop-metrics.py — thin shim. The implementation lives in `loopkit_core.loop_metrics`.
...
`loop_metrics` is loaded here by `importlib.util.spec_from_file_location` from
...
from loopkit_core import loop_metrics as _impl  # noqa: E402
