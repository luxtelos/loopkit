#!/usr/bin/env python3
"""ticks.py — thin shim. The implementation lives in `loopkit_core.ticks`.
...
`ticks` is loaded here by `importlib.util.spec_from_file_location` from
...
from loopkit_core import ticks as _impl  # noqa: E402
