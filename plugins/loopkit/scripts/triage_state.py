#!/usr/bin/env python3
"""triage_state.py — thin shim. The implementation lives in `loopkit_core.triage_state`.
...
`triage_state` is loaded here by `importlib.util.spec_from_file_location` from
...
from loopkit_core import triage_state as _impl  # noqa: E402
