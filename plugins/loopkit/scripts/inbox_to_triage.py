#!/usr/bin/env python3
"""inbox_to_triage.py — thin shim. The implementation lives in `loopkit_core.inbox_to_triage`.
...
`inbox_to_triage` is loaded here by `importlib.util.spec_from_file_location` from
...
from loopkit_core import inbox_to_triage as _impl  # noqa: E402
