...
# The PROJECT being gated, never the directory this script happens to sit in.
# `$(dirname "$0")/..` was correct only while the script lived inside the repo
# it gates; the moment it ships from a plugin cache that expression points at
